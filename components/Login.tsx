    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-100 p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-blue-600 p-8 text-center relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full opacity-10 bg-[url('https://www.transparenttextures.com/patterns/medical-icons.png')]" />
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 mt-2 text-sm font-medium uppercase tracking-wide">
...
function getLoginErrorMessage(err: any) {
  ...
  if (code === 'RPC_ROUTE_MISSING') {
    return 'Không kết nối được máy chủ. Nếu đang test local, hãy chạy vercel dev thay vì npm run preview.';
  }
